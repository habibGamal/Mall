    ...
    return (
        <section className="single-page-form dark">
            <div className="container">
                ...
                <form ref={productForm} onSubmit={productStore} className="form" encType="multipart/form-data">
                    <h3>Required</h3>
...
export default connect(mapPropsFromState,{setPicture})(CreateProduct);
...
function Preview({ to, picture }: { to: string, picture: Picture }) {
    // note: index is considered as id in case of byId is true
    const { base: imgSrc } = picture;
    ...
    const pickPicture = new PickPicture({ toggleImg, imgBoundry, imgDrag, img, setRange, setToggle, picture: picture });
    return (
